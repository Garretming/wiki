...
if __name__ == '__main__':
    ...
    if count >2 and count >=4 :
        ...
        os.system('curl -u Garretming -d \'{"name":"Garretming.github.io","description":"Garretming.github.io is a blog show page for blog"}\' https://api.github.com/user/repos')
        # os.system('git remote add origin git@gitlab.com:' + store +'/' + name +'.git')
        os.system('git remote add origin git@github.com:Garretming/Garretming.github.io.git')
